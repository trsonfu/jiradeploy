...
const Offcanvas = () => {
    ...
    const ScrollBar=()=>{
        ...
        console.log(ScrollBarThemes.setAttribute("data-layout-position","scrollable"));
                            ...
                            <div className="settings-mains">
                                ...
                                <div id="layout-position">
                                    ...
                                    <div className="btn-group bor-rad-50 overflow-hidden radio" role="group">
                                        ...
                                        <label className="btn btn-light w-sm" htmlFor="layout-position-fixed" onClick={Fixed}>Fixed</label>
                                        <input type="radio" className="btn-check" name="data-layout-position" id="layout-position-scrollable" defaultValue="scrollable" />
                                        <label className="btn btn-light w-sm ms-0" htmlFor="layout-position-scrollable" onClick={ScrollBar}>Scrollable</label>
                                    </div>
                                </div>
                                <div className="layout-head pt-3">
                                    <h5>Topbar Color</h5>
